...
function Upperside() {
    return (
        <div className=" lg:h-screen lg:w-full md:h-96 bg-no-repeat bg-slate-700 text-white bg-[url('images/image3.png')]  " >
            <Navbar />
            <div className="w-full flex justify-center lg:mt-32 lg:pt-10 md:mt-10  ">
