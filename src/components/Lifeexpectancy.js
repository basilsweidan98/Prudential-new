...
function Lifeexpectancy() {
    return (
        <div className=' flex mt-20 ml-5 mr-7'>
            <div >
                <h1 className=' grow pr-20 text-3xl pt-2 container lg:pt-0 md:pt-0 md:text-5xl lg:text-7xl w-1/3 font-bold text-stone-900'>Life expectancy <br /><span className='text-slate-400 '>algorithm</span></h1>
            </div>

            <div className='text-xs lg:text-lg  md:text-sm  lg:mt-5 lg:pl-20 container'>
                <p className='  font-sans  text-gray-600 mb-2 lg:w-11/12 lg:mb-11 container '>PruScore Alpha is an algorithm that is utilised at present within Prudential to predict life expectancy for their Life products. The algorithm has further commercial benefits across other Prudential business lines, as well as opportunities to commercialize to the external market as a product.</p>
