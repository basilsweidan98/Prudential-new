...
function Lifeexpectancy() {
    return (
        <div className=' flex mt-20 ml-5 mr-7 flex-1 lg:space-x-32 font-inter'>
            <div >
            ...
            <div className=' lg:mt-5  '>
                <p className=' font-inter  text-gray-600  mb-2 lg:w-11/12 lg:mb-7 text-xs lg:text-base   md:text-sm   xl:pb-3 2xl:pb-7 '>PruScore Alpha is an algorithm that is utilised at present within Prudential to predict life expectancy for their Life products. The algorithm has further commercial benefits across other Prudential business lines, as well as opportunities to commercialize to the external market as a product.</p>
                <a href="#" className='bg-yellow-400  rounded font-semibold lg:font-bold lg:p-3 lg:pl-6  lg:pr-6 text-black text-xs p-1 hover:border'>Learn more</a>
            </div>
        </div>
    )
}
