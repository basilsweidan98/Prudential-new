...
function Prudentialleft() {
    return (
//         <div className="lg:h-80 md:h-72 h-56  ml-3 bg-sky-600 border lg:ml-5 md:ml-5 rounded hover:shadow-xl ">
//             <div className="  text-white  text-x   " >
            
//                 <p className=" lg:font-bold md:font-bold font-semibold text-xs lg:mt-20 lg:pt-20 pt-32 md:pt-20 md:mt-24 lg:ml-14 md:ml-10 ml-2 lg:text-2xl   ">Prudential Foundation’s giving surpasses $1 billion mark</p>
